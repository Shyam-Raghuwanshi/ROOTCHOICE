        ...
        <div className="max-w-2xl mx-auto">
          <div className="bg-gray-900 rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
              ...
              <div className="flex flex-col items-center pt-8">
                ...
                <div className="flex mt-4 space-x-3 lg:mt-6">
                  <div className="w-full flex justify-between mt-2 ">
                    ...
                    >
                      <span className="ml-3 cursor-pointer text-gray-200">
                        <svg
                          fill="currentColor"
                          strokeLinecap="round"
                    ...
                    <Link
                      passHref
                      href={"http://instagram.com/shyam_raghuonec"}
                      target={"_blank"}
                    >
                      <span
                        target="_blank"
                        className="ml-3 cursor-pointer text-gray-200"
                      >
                        <svg
                          fill="none"
                          stroke="currentColor"
            ...
            <div>
              ...
              &quot;Hey, I&apos;am who you are looking for!&quot;Experienced web developer
