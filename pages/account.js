...
const checkout = ({ setSideCart }) => {
  ...
  const handleDetails = async (e) => {
    ...
    const res = await fetch(
      `${process.env.NEXT_PUBLIC_HOST}/api/updateuserdetail`,
      {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(body),
              ...
              <div className="">
                ...
                <div className="mt-4">
                  <button
                    ...
                    className="disabled:bg-gray-600 disabled:text-gray-500 w-full rounded-lg px-6 py-2 text-white bg-gray-900 active:bg-gray-800 "
                  >
                    Conform change
                  </button>
                </div>
