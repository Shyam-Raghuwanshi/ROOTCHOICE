  ...
  return (
    <>
      {cart == null || cart.length == 0 ? (
        <div className="md:text-5xl text-gray-300 bg-gray-900 py-40 text-center font-bold">
          Your cart is Empty. Please add some items for checkout :)
        </div>
      ) : (
        <div className=" bg-gray-900 text-gray-200 mx-auto">
          <Head>
            <title>Buynow</title>
            <meta
              name="viewport"
              ...
              >
                <div className="">
                  ...
                  <div className="mt-4">
                    ...
                    <button
                      disabled={disable}
                      className="disabled:bg-gray-600 disabled:text-gray-500 w-full rounded-lg px-6 py-2 text-white bg-gray-700 active:bg-gray-800 "
                    >
              ...
              <div className="pt-12 md:pt-0 2xl:ps-4">
                ...
                <div className="mt-8 ">
                  {cart !== undefined && cart !== null && cart.length == 0 && (
                    <div className="w-full flex text-center justify-center text-sm sm:text-xl font-semibold">
                  ...
                  {cart !== undefined &&
                    ...
                    cart.map((k) => {
                      return (
                        <div
                          key={k.slug}
                          className="flex  mt-14 flex-col space-y-4 border-gray-300 border-b-2 pb-2"
                        >
